...
jQuery(document).ready(function ($) {
    ...
    // ==================
    // CSSeco Contact Form Submission
    // ==================
    $('#cssecoContactForm').on('submit', function(e){
        e.preventDefault();
        ...
        if( name === '' ){
            ...
            $('#name').parent('.form-group').removeClass('has-error').addClass('has-success');
        }
        if( email === '' ){
        ...
        if( message === '' ){
            ...
            $('#message').parent('.form-group').removeClass('has-error').addClass('has-success');
        }
        ...
        $.ajax({
            ...
            data : {
                ...
                email : email,
                message : message,
                action : 'csseco_save_user_contact_form'
            },
            error : function( response ){
